...
<%@ page import="assignment_3.Status" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="status.code.label" default="Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: statusInstance, field: "code")}</td>
